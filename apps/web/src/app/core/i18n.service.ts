...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  es: {
    ...
    'contact.preview': 'Esto abrirá tu app de correo para enviar un mensaje al equipo de CrisisMap.',
  ...
  en: {
    ...
    'contact.preview': 'This will open your mail app so you can send a message to the CrisisMap team.',
    'contact.close': 'Close',
  ...
  pt: {
    ...
    'contact.cancel': 'Cancelar',
    'contact.preview': 'Isto abrirá o seu app de e-mail para enviar uma mensagem à equipa do CrisisMap.',
